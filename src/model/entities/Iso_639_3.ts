...
export class Iso_639_3 {
  ...
  @Column('varchar', { name: 'part_2b', nullable: true, length: 3 })
  part_2b!: string | null;

  @Column('varchar', { name: 'part_2t', nullable: true, length: 3 })
  part_2t!: string | null;

  @Column('varchar', { name: 'part_1', nullable: true, length: 2 })
  part_1!: string | null;
  ...
  @Column('varchar', { name: 'comment', nullable: true, length: 150 })
  comment!: string | null;
}
